# Operator Quickstart — Manufacture of other non-metallic mineral products n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 2399** (`cloud-itonami-isic-2399`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2399.git
cd cloud-itonami-isic-2399
```
...
- Blueprint governor key: `mineral-wool-plant-operations-governor`
- Likely source path: `mineralwoolmfg.governor.cljc`
