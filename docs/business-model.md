# Business Model: Manufacture of other non-metallic mineral products n.e.c.
...
## Classification
- Repository: `cloud-itonami-isic-2399` ([github.com/cloud-itonami/cloud-itonami-isic-2399](https://github.com/cloud-itonami/cloud-itonami-isic-2399))
- ISIC Rev.5: `2399` — Manufacture of other non-metallic mineral products n.e.c.
- Domain: `:mineral-wool-insulation/manufacturing`
- Social impact: :worker-safety :materials-safety :resource-efficiency
- Actor: `:mineral-wool-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :mineral-wool-insulation/manufacturing — who wants
...
One managed tenant (:mineral-wool-insulation/manufacturing):
...
- Do not bypass the `:mineral-wool-plant-operations-governor` for production decisions.
