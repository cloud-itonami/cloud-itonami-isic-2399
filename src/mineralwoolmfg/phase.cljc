(ns mineralwoolmfg.phase
  "Phase 0->3 staged rollout for the ISIC 2399 (Manufacture of other
  ...
  consequence (a forming/curing-line-equipment maintenance window
  means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `mineralwoolmfg.governor`'s `forming-curing-line-actuate-blocked-
...
(defn verdict->disposition
  "Map a Mineral Wool Plant Operations Governor verdict to a base
